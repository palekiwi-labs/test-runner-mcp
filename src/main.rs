...
struct Cli {
    ...
    #[arg(short = 'y', long, default_value = "npx cypress run --spec")]
...
async fn main() -> anyhow::Result<()> {
    ...
    let ct = sse_server.with_service(move || TestRunner::new(cli.rspec_command.clone(), cli.cypress_command.clone(), cli.cypress_working_dir.clone()));
